...
//todopack part
Route::get('/todopackall', [TodoPackController::class, 'index'])->name('todopack.indexpack');
//Route::get('/todolist', [TodoPackController::class, 'search']);
...
//todolist part
Route::get('/todolistall', [TodoListController::class, 'index'])->name('todolist.indexlist');
